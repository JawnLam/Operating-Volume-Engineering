...
|-------------------------|---------------|------------------------------------------------------------------------|
| **Software**            | v2.9.0        | Minor release — Convention 12 (Registry Sync) + 09-CLOSE-OUT.md + F17 (Shipped by precedent); the release lifecycle codified: ship records, upgrade choreography with preservation walk, registry sync, independence sweep, graduation, records discipline. Additive over v2.8.0 |
...
| **Design engine**       | v2.9          | v2.9: chapter `09-CLOSE-OUT.md`, Convention 12 (Registry Sync), F17, Phase 9 rewire. v2.8 (Convention 15, F16, QC-governance protocol + gate edits) and prior retained |
| **Templates**           | v2.8          | v2.8: pre-registered sampling-plan & severity-rubric block added to `TEMPLATE-golden-session-script.md` (v2.6 introduced the template) |
...
- **Design engine** in `_design-engine/`:
  - Ten core operating files (`00–09`) plus `BOOTSTRAP-NEW-OV.md` (v2.3 adds `08-KNOWLEDGE-RETRIEVAL.md`, the OKF bridge protocol; v2.9 adds `09-CLOSE-OUT.md`, the release-lifecycle protocol)
