...
# SOLVE-eX — Vetting Rubric (filled)
...
| ID | Title | Tier | Gate | Moat | Weight | Score | Weighted |
|---|---|---|---|---|---|---|---|
...
| REQ-D1 | Curated Authoritative Corpus (RAG) | T1 | — | — | 3 | 3 | 9 |
| REQ-D2 | Recency / Freshness | T1 | — | — | 3 | 1 | 3 |
| REQ-D3 | Source Attribution & Verifiability | T1 | — | — | 3 | 3 | 9 |
...
| **This OV's weighted score** | **503** |
| **Percentage** | **90.1%** |
| Moat coverage | **4/5** (E4=3, M1=0, M2=3, M3=3, M4=2) |

## Gating rule check

- All 5 T0 hard gates scored ≥2? **Yes**
- All 8 applicable TG gates scored ≥2? **Yes**
- Gating-rule veto fires? **No**

## Verdict

**Defensible specialist — earns operator preference over a general LLM for structured decision-making and problem-solving.**

Percentage ≥80% AND no gate failure → top verdict band. Three moat items (REQ-E4 scenario simulation, REQ-M2 system-of-record, REQ-M3 proprietary curation) carry durability cleanly. REQ-M1 (Data Flywheel) is honestly deferred; REQ-M4 (Cohort) is domain-inappropriate per substrate caveat. The 677-entry tool corpus + 14-chapter methodology + 21-step process IS the moat — REQ-M3 captures this directly.

> **Honest gaps:** REQ-D2 (Recency), REQ-E3 (Closed-Loop), REQ-G3 (Preference Learning), REQ-H1 (Proactive Cadence), REQ-J4 (Value Attribution) all score `partial`. Each is a real, named opportunity for a future revision.
